      ...
      <form onSubmit={handleSubmit} className="fade-in">
        <CardContent className="space-y-6 pt-6">
          <div className="space-y-2">
            ...
            <div className="space-y-2">
            <Label htmlFor="description" className="text-sm font-medium">{t.creation.idea.form.description}</Label>
            <Textarea
              id="description"
              name="description"
              placeholder={t.creation.idea.form.description_placeholder}
